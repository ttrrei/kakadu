...
6. **ODS DDL Scripts**: Rewrite `install_ods_tables.sql` per ADR-005 — 6 tables with only `BATCH_ID` + `LOAD_TIME` audit columns, all columns as `VARCHAR2`
...
## 7. Test Benchmarks & Performance Metrics
