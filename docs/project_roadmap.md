...
**Idempotency & Auditability**: Repeating the same batch does not compromise ODS traceability; all data carries `LOAD_TIME`, `SOURCE_SYSTEM`, and `BATCH_ID` audit markers.
