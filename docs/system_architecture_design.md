...
| ODS_ANALYST_TRENDS | Analyst Trends | Rating trends & consensus | Weekly (Sun 07:00) | (CODE, UPDATE_DATE) | ODS_CONSENSUS (Split) |
| ODS_ANALYST_TARGETS | Analyst Targets | Price targets & valuation | Weekly (Sun 07:00) | (CODE, UPDATE_DATE) | ODS_CONSENSUS (Split) |
...
| Browser Isolation & Purge | Sequential Selenium execution followed by cleanup_vm.sh (only for annc) | Prevents orphan Chrome processes from leaking RAM |
